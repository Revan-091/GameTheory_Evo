...
def main():
    ...
    for _ in range(num_cavalry_a):
        position1 = (random.uniform(7, 9), random.uniform(85, 140))
        position2 = (random.uniform(45, 60), random.uniform(155, 168))
    ...
    # Add arrows for direction indicators
    ax.arrow(100, 100, 0, 10, head_width=1, head_length=2, fc='k', ec='k')   # North
    ax.arrow(100, 100, 0, -10, head_width=1, head_length=2, fc='k', ec='k')  # South
    ax.arrow(100, 100, 10, 0, head_width=1, head_length=2, fc='k', ec='k')   # East
    ax.arrow(100, 100, -10, 0, head_width=1, head_length=2, fc='k', ec='k')  # West

    # Set aspect ratio to be equal so that arrows are not distorted
    ax.set_aspect('equal')
